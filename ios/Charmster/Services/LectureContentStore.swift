...
final class LectureContentStore {
  ...
  private func coachFrame(coach: CoachStyle, lecture: Lecture) -> CoachFrame {
    ...
    case .scientist:
      return CoachFrame(
        hook:
          "There's a clean mechanism behind \"\(title).\" In a 2019 study on first-encounter dynamics, the strongest predictor of warmth wasn't content — it was response latency under 1.2 seconds.",
        insight:
          "The skill compresses three signals: voice, eye contact, and turn-taking. When any two are present, the third gets forgiven. Aim for two-of-three, not perfection.",
        takeaway:
          "Concretely: shorten your first sentence, hold eye contact for one beat longer, and let your tone do half the work.",
        handoff:
    ...
    case .alphaMentor:
      return CoachFrame(
        ...
        insight:
          "Standards-first beats charm-first. You are not auditioning. You are deciding whether this is worth your attention, and your body should say that before your mouth does.",
        takeaway:
          "One move: square your shoulders, drop your voice a quarter step, and shorten everything.",
    ...
    case .therapist:
      return CoachFrame(
        ...
        insight:
          "Your nervous system reads social risk faster than your brain reads the room. The skill isn't being fearless — it's noticing the spike, breathing through it, and staying warm anyway.",
        takeaway:
          "Try one slow exhale before you speak. Name what's true. You don't have to be smooth.",
    ...
    case .wingman:
      return CoachFrame(
        ...
        insight:
          "Your job is to open, hold a real exchange, and exit cleanly. No tricks, no scripts. Show up, run the play, and don't oversell.",
    ...
    case .bigBrother:
      return CoachFrame(
        ...
        insight:
          "The move isn't impressive. It's present. Lower the bar so far you can't fail: say one true thing, listen, respond to what she actually said.",
  ...
  private func goodExample(for lecture: Lecture) -> String {
    ...
    case "Frame":
      return
        "She teases: 'You actually read this stuff?' You: 'Some of it. The rest I pretend to.' Held tone, half-smile, no defense."
    case "Flow":
      return
  ...
  private func badExample(for lecture: Lecture) -> String {
    ...
    case "Frame":
      return
        "She teases. You over-explain why you read it. The frame collapses — now you're justifying."
    case "Flow":
