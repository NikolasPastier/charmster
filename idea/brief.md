...
### Identity model
- **AI partner** (practice persona): `AvatarPersona` / `AvatarView` / `PartnerStillImage` — the simulated person the user practices with. Separate system, untouched.
...
- Plan reveal now shows "You + partner" paired avatars.
